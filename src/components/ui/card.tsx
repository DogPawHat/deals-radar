...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "bg-card text-card-foreground overflow-hidden rounded-sm border border-border py-6 text-sm transition-all data-[size=sm]:gap-4 data-[size=sm]:py-4 group/card flex flex-col",
